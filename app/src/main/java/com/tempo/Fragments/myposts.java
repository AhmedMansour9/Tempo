...
import com.tempo.Activites.ActivityOneItem;
import com.tempo.Activites.Home;
import com.tempo.Interface.itemViewinterface;
import com.tempo.Model.CustomGallery;
import com.tempo.Model.Retrivedata;
import com.tempo.R;
import com.tempo.adapter.Adapteritems;
import com.tempo.adapter.imgclick;
 ...
 */
public class myposts extends Fragment implements itemViewinterface,SwipeRefreshLayout.OnRefreshListener,imgclick {
...
//                            holder.ProgrossSpare.setVisibility(View.GONE);
    ...
    public void onClickdelete(View view, final int adapterPosition) {
        ...
        builder.setMessage(getActivity().getResources().getString(R.string.delete_post));
    ...
    public void Retrivedata(){
        ...
        data.orderByChild("social_id").equalTo(SharedPrefManager
            .getInstance(getContext()).getSocialId()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    public void imgfileone(Uri filePath,final String childimage, final ImageView image, final String IMAGE) {
        ...
        waitingdialog.setTitle(getActivity().getResources().getString(R.string.loading));
        waitingdialog.show();
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(editname.getText().toString().isEmpty()||editdiscount.getText().toString().isEmpty()||
                    ...
                    Toast.makeText(getContext(), getActivity().getResources().getString(R.string.validate_data), Toast.LENGTH_LONG).show();
                    ...
                    Snackbar.make(rootlayout, getActivity().getResources().getString(R.string.savedsucces), Snackbar.LENGTH_LONG)
                            .show();
